    ...
    <section class="container section-intro my-5">
      ...
      <div id="section_4" class="intro-details">
        ...
        <div class="col-md-3">
          ...
          <div class="info-description">21 K y 10 K</div>
        </div>
...
<script>
  ...
  const testimonialImages = [
    { url: "<?= $cdn ?>/Images/2026/testimonio1.JPG", alt: "Testimonio 1" },
    { url: "<?= $cdn ?>/Images/2026/testimonio2.JPG", alt: "Testimonio 2" },
    { url: "<?= $cdn ?>/Images/2026/testimonio3.JPG", alt: "Testimonio 3" },
    { url: "<?= $cdn ?>/Images/2026/testimonio4.JPG", alt: "Testimonio 4" },
    { url: "<?= $cdn ?>/Images/2026/testimonio5.JPG", alt: "Testimonio 5" },
  ];
