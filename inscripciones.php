...
<head>
    ...
    <title>Inscripciones Media Maratón Entre Montañas</title>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="styles.css?vers=2025-07-20">
...
<body><br><br><br><br>
 ...
 <section class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-5">
                ...
                <div class="hero-section">
                    ...
                    <h2 class="hero-title">Información de Inscripción️</h2>
    ...
    <select name="distancia" required>
      <option value="">Seleccione</option>
      <option value="Masculino">10K</option>
      <option value="Femenino">21K</option>
    </select><br><br>
